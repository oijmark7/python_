def func_a(scores1, scores2):#기말고사 점수에 중간고사 점수를 뻰 값의 최댓값 함수
    answer = 0
    for score1, score2 in zip(scores1, scores2):
        answer = max(answer, score2 - score1)
    return answer

def func_b(scores1, scores2):#기말고사 점수에서 중간고사 점수를 뺸 값의 최솟값 함수
    answer = 0
    for score1, score2 in zip(scores1, scores2):
...
def solution(mid_scores, final_scores):
    ...
    answer = [up, down]#1번2과 과정에서 구한점수를 리스트에 담아 return
    return answer

# 아래는 테스트케이스 출력을 해보기 위한 코드입니다. 아래에는 잘못된 부분이 없으니, 위의 코드만 수정하세요.
mid_scores = [20, 50, 40]#중간고사
